...
class IntermediateMode extends StatefulWidget {
  const IntermediateMode({Key? key}) : super(key: key);

  @override
  State<IntermediateMode> createState() => _IntermediateModeState();
}

class _IntermediateModeState extends State<IntermediateMode> {
                          ...
                          if(isLastQuestion == true){
                            setState((){
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context) =>  SplashScreenFinish(score: score * 40,)));
                            });
                          }
                        },
                      );
